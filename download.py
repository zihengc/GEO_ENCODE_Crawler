"""Utility function to download data. Modified from Choudhary, S. (2019) 'pysradb: A Python package to query next-generation sequencing metadata and data from NCBI Sequence Read Archive'"""
...
def download_file(
    ...
    if os.path.exists(file_path) and os.path.getsize(file_path):
        print("File exists, please change file_path.")
        return
